 ...
 *
 * @deprecated Use real runtime testing instead: import { createTestRuntime } from '@voidcatos/core/test-utils'
 *
 * @example Legacy Mock Testing (Deprecated)
 * ```typescript
 * import { createMockRuntime } from '@voidcatos/core/test-utils';
 *
